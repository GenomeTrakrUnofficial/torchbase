...
class RequestClasses(object):
    ...
    class torchbase_models(object):
        ...
        class VersionRequestClass(DictWrapper):
            
            
            RECORD_SCHEMA = PROTOCOL_MESSAGES["Version"].request
            
            
            def __init__(self, inner_dict=None):
                super(RequestClasses.torchbase_models.VersionRequestClass, self).__init__(inner_dict)
                if inner_dict is None:
                    self.version = str()
        ...
        class DescriptionRequestClass(DictWrapper):
            
            
            RECORD_SCHEMA = PROTOCOL_MESSAGES["Description"].request
            
            
            def __init__(self, inner_dict=None):
                super(RequestClasses.torchbase_models.DescriptionRequestClass, self).__init__(inner_dict)
                if inner_dict is None:
        ...
        class NameRequestClass(DictWrapper):
            
            
            RECORD_SCHEMA = PROTOCOL_MESSAGES["Name"].request
            
            
            def __init__(self, inner_dict=None):
                super(RequestClasses.torchbase_models.NameRequestClass, self).__init__(inner_dict)
                if inner_dict is None:
                    self.name = str()
...
'torchbase_models.ProfileElement': SchemaClasses.torchbase_models.ProfileElementClass,
    ...
    'torchbase_models.Version': RequestClasses.torchbase_models.VersionRequestClass, 
    'torchbase_models.Description': RequestClasses.torchbase_models.DescriptionRequestClass, 
    'torchbase_models.Name': RequestClasses.torchbase_models.NameRequestClass, 
